 ...
 * computation functionality.  However, this requires us to store the 
 * sub-objects (the stations) using a TreeMap and to implement Iterable
 * 
 * <P>
 * Project 5<BR>
 * @version 2016-11-18
...
public class CountyDefinition extends MultiStatisticsAbstract 
{
     ...
     * Constructor. <P>
     * 
     * Elements array contains: <P>
     * 0. The name of the county <B>
     * 1/2: long/lat of first point in the polygon.  <BR>
     * 3/4: long/lat of the 2nd point, <BR>
     * ... as many points as are necessary
     * <P>
     * The number of long/lat coordinates is not assumed to be known 
     * ahead of time.
     * 
    ...
    public CountyDefinition(String[] elements)
    {
        ...
        {
            //start at 1 (0=name), get 1/2, 3/4, 5/6, ...  
            polygon.addPoint(((int) (Double.parseDouble(elements[i])
                    * StateFrame.LONGITUDE_SCALE)), 
                    ((int) (Double.parseDouble(elements[++i]) 
     ...
     * 
     * <P>
     * The following are drawn: a fill of the polygon with the 
     * county's color, an outline of the polygon in black,
     * and the included stations
     * 
     * @param g2 Graphics context in which to draw the county
     */
    protected void draw(Graphics2D g2)
    {
        ...
        // TODO: draw stations
        //need to iterate through stations, a treemap with keys 0,1,2...
        //then, for every stationdefinition in the tree map, do the below
        for (int i = 0; stations.get(i) != null; ++i)
        {
     ...
     *  
     * @param o New value for the sample
     */
    ...
    /**
     * Add a station to the list of stations.  The keys for
     * the stations are in numeric order: 0, 1, 2, ...
     * 
     * @param station The station to be added
     */
    public void addStation(StationDefinition station)
    {
        //same thing with the tree map
     ...
     * 
     * @param i Key to find the station
