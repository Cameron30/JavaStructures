...
public class StateFrame extends JFrame
{
    ...
    public class SelectionPanel extends JPanel
    {
        ...
        public SelectionPanel()
        {
            ...
            variableList = new JList<String>(dataDefinitionList
                    .getVariableIds().toArray(new String[0]));
            ...
            // Month list
            String[] mList = { "All", "Jan", "Feb", "Mar", "Apr", "May", "Jun",
     ...
     * 
     * @author CS 2334. Modified by Cameron / Justin
     * @version 2016-11-04
     * 
     */
    public class CountyPanel extends JPanel
    {
        ...
        public CountyPanel()
        {
            ...
            this.addMouseListener(new MouseAdapter()
            {
                ...
                public void mouseClicked(MouseEvent e)
                {
                    ...
                    CountyDefinition selectedCounty = 
                            countyDefinitionList.findCounty(x, y);

                    // if there is one.
                    if (selectedCounty != null)
                    {
                        CountyFrame tempFrame = 
                                new CountyFrame(selectedCounty);
            ...
            colorBar = new ColorBar(XVARIABLE, 375, 500, 
                    50, 100, .2, .4, .2, 0, 1, 0); 
            ...
            // TODO: Build the linked list of constraints
            constraintsYear.addEnd(constraintsMonth);
            constraintsYear.addEnd(constraintsDay);
            constraintsStations.addEnd(constraintsYear);

            // TODO: initialize constraintsStations

            //TODO ^^ IT SAYS MAX OF 10 STATIONS, SO I DEFAULT TO 10
        ...
        protected void paintComponent(Graphics g)
        {
            ...
            // Draw all of the counties
            countyDefinitionList.draw(g2);

            // Draw the color bar
            colorBar.draw(g2);

            //DataDefinitionList dl = StateFrame.this.dataDefinitionList;
            ...
            DataDefinition dataDefinition = StateFrame.this.dataDefinitionList
                    .getDataInfo(variableId);
            if (dataDefinition != null)
            {
                ...
                String unit = dataDefinition.getUnit();
                // draw the units
                g2.drawString(unit, XVARIABLE, YVARIABLE + 100);
            }
        ...
        public synchronized void updateData()
        {
            ...
            List<String> selectedYears = 
                    StateFrame.this.selectionPanel.yearList
            ...
            for (String s : selectedYears)
            {
                if (!s.equals("All"))
                {
                    constraintsYear.add(Integer.parseInt(s));
                }
            ...
            for (int s : selectedMonths)
            {
                if (s != 0)
                {
                    constraintsMonth.add(s);
                }
            }

            // Days
            int[] selectedDays = StateFrame.this.selectionPanel.dayList
                    .getSelectedIndices();
            ...
            for (int s : selectedDays)
            {
                if (s != 0)
                {
                    constraintsDay.add(s);
                }
            }
            ...
            else if (selectionPanel.maxButton.isSelected())
            {
     ...
     * 
     * @param offsetX Offset along the X dimension
     */
     ...
     * Set the linear offset from long/lat to screen coordinates
     * 
     * @param offsetY Offset along the Y dimension
     */
    ...
    /**
     * Load a data file into the main data structure.  After the data are 
     * loaded, the yearListModel is updated to reflect
     * the current set of years.
     * 
     * @param fileName  File from which the data will be loaded
     * @throws IOException If some for of error occurs during the opening
